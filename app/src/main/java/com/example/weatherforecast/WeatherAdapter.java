...
public class WeatherAdapter extends RecyclerView.Adapter<WeatherAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        //String formattedDateTime = sdf.format(weatherItem.getDateTime());
        String formattedDateTime = DateUtils.formatDateTimeString(weatherItem.getDateTime());
        String modifiedDateTime = formattedDateTime.substring(0, formattedDateTime.length() - 3);
        holder.dateTimeTextView.setText(modifiedDateTime);
